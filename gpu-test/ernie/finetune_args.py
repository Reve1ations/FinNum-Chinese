...
train_g.add_arg("task",              str,    "term",   "ATSA or ACSA")
train_g.add_arg("epoch",             int,    4,       "Number of epoches for fine-tuning.")
train_g.add_arg("learning_rate",     float,  3e-5,    "Learning rate used to train with warmup.")
